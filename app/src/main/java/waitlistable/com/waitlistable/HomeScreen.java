...
public class HomeScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nHead.setTextColor(Color.WHITE);
        ...
        pHead.setTextColor(Color.WHITE);
        ...
        phHead.setTextColor(Color.WHITE);
        ...
        sendHead.setTextColor(Color.WHITE);
        ...
        removeHead.setTextColor(Color.WHITE);
